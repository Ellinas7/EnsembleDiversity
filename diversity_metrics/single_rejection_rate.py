...
class single_rejection_rate(diversity_metric):
    """
    Single Rejection Rate: quantifica la probabilità che il classificatore
    si astenga dalla classificazione.
    
    Formula: (FR + TR) / (TA + FA + FR + TR)
