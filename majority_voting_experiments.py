...
OUTPUT_FILE = "/Users/matteopascuzzo/Desktop/MajorityVoting.csv"
...
def run_experiment(ds, trained_classifiers: dict, triple: tuple, rejection_name: str, 
    ...
    # Crea ensemble
    ensemble = MajorityVotingEnsemble([clf1, clf2, clf3])
...
def main():
    print("=" * 70)
    print("MAJORITY VOTING - EXPERIMENT RUNNER")
    print("=" * 70)
